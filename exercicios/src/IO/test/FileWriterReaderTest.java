...
public class FileWriterReaderTest {
	...
	public static void main(String[] args) {
		...
		try {
			...
			FileWriter fw = new FileWriter(file); //Criando o obj para escrever no arq, querendo sobrescrever nele. Se ja existir algo escrito, e vc escrever algo diferente no writer(), ele irá sobrescrever o arquivo!
